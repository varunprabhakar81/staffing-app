...
## GitHub Milestones (created Session 13)
...
- Update session_tracker.md at the start and end of each session
- The rules in NewChatPrompt.md are permanent — do not remove them
