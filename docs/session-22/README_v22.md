...
│   ├── app.js             # Frontend SPA logic (v=75)
...
This project is built using Claude Code (CC) as a co-pilot. Each session starts with a new Claude chat — upload HANDOFF_v22.md and session-dashboard_v22.html to load context.
...
- **Sessions:** 22 build sessions completed
- **Issues closed:** 67
- **Current milestone:** Phase 2 — #161 Rolling Off Soon apostrophe fix next

See `Roadmap_v22.md` for the full prioritized build queue.
