...
Last updated: Session 22 · March 27 2026
...
| Phase 2 | 21 open | ~120–150h |
| V3 | 13 open | ~80–100h |
| **Total** | **34 open** | **~200–250h** |

67 issues closed · V1 Stable complete · UAT 48/48 passed · Phase 2 in progress
...
## Phase 2 — Core Quality & UX

### Priority order

| # | Title | Type | Est. | Note |
|---|---|---|---|---|
| #161 | Rolling Off Soon KPI — apostrophe in consultant name breaks modal click | bug | 1h | data-cid pattern |
| #160 | KPI drilldown modals — Available Capacity, Utilization %, On Bench open expanded + Expand/Collapse All | enhancement | 2h | |
| #155 | Rolling Off Soon panel — cap at 4 rows + View all (N) link | enhancement | 1–2h | |
| #157 | AI acceptance 0h overwrite bug | bug | 2–3h | |
| #159 | Consultant skill sets not consistently resolved at load time in supabaseReader.js | bug | 2–3h | |
| #158 | Recommendations engine misses valid consultant matches | bug | 2–3h | Depends on #159 |
...
| #156 | Open Needs — filter/hide Fully Met rows by default, with toggle | enhancement | 1–2h | |
| #154 | Holistic UI/UX design pass (Phase 2 scoped) | polish | — | Supersedes #132 |
| #129 | Historical staffing snapshots + time-travel view | feat | 8–12h | Supersedes #121 |
| #144 | Consultant name popup covers the name on click | bug | 1h | |
| #145 | Week header modal — add jump to consultant row or inline edit | enhancement | 2–3h | |
| #137 | On Bench modal count mismatch | bug | 1h | |

### New Phase 2 issues logged Session 22 (GitHub #155–#161)

| GitHub # | Title | Label |
|---|---|---|
| #155 | Rolling Off Soon panel — cap at 4 rows + View all (N) link | enhancement |
| #156 | Open Needs — filter/hide Fully Met rows by default, with toggle to show all | enhancement |
| #157 | AI acceptance 0h overwrite bug | bug |
| #158 | Recommendations engine misses valid consultant matches — Benjamin Liu not suggested for R2R Consolidation | bug |
| #159 | Consultant skill sets not consistently resolved at load time in supabaseReader.js | bug |
| #160 | KPI drilldown modals — Available Capacity, Utilization %, On Bench should open expanded with Expand/Collapse All button | enhancement |
...
13 issues. None ship until tenant onboarding (#96) is complete — that is the V3 gate.
