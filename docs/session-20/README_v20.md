...
- **Availability heatmap** — Rolling 12-week view of consultant hours across all projects. Inline editing with instant save. 4-tier color scheme: Red 0–10h / Yellow 11–44h / Green 45h / Orange 46h+. No spreadsheets.
...
- **Staffing needs pipeline** — Open demand roles matched against available consultants with AI-powered recommendations. Accepted matches persist to database.
...
- **Consultant profiles** — Edit consultant details, skill sets, level, and location from a Settings panel. Includes live password strength enforcement for invites.
...
- Invite flow: temp password only (magic link removed). SSO placeholder for Phase 2.
...
│   ├── app.js             # Frontend SPA logic (v=53)
│   ├── styles.css         # Dark theme styles (v=40)
...
This project is built using Claude Code (CC) as a co-pilot. Each session starts with a new Claude chat — upload HANDOFF_v20.md and session-dashboard_v20.html to load context.
...
- **Version:** V1 Stable — UAT complete ✅
- **Consultants:** 25 real employees, real project data
- **Sessions:** 20 build sessions completed
- **Issues closed:** 59
- **Current milestone:** Phase 2 — starting with #96 tenant onboarding

See `Roadmap_v20.md` for the full prioritized build queue.
