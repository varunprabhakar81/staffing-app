...
- **Consultant profiles** — Edit consultant details, skill sets, level, and location from a Settings panel. Also accessible by clicking consultant name in heatmap.
...
│   ├── app.js             # Frontend SPA logic (v=83)
│   ├── styles.css         # Dark theme styles (v=41)
...
This project is built using Claude Code (CC) as a co-pilot. Each session starts with a new Claude chat — upload HANDOFF_v23.md and session-dashboard_v23.html to load context.
...
- **Sessions:** 23 build sessions completed
- **Issues closed:** 76
- **Current milestone:** Phase 2 — #152 skill set pill next

See `Roadmap_v23.md` for the full prioritized build queue.
