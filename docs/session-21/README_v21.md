...
│   ├── app.js             # Frontend SPA logic (v=67)
...
This project is built using Claude Code (CC) as a co-pilot. Each session starts with a new Claude chat — upload HANDOFF_v21.md and session-dashboard_v21.html to load context.
...
- **Sessions:** 21 build sessions completed
- **Issues closed:** 64
- **Current milestone:** Phase 2 — #142 Overallocated Resources rename next

See `Roadmap_v21.md` for the full prioritized build queue.
