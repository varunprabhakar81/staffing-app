...
- **Recommendations qualify on ≥1 week of capacity** — consultant qualifies if they have ≥ hoursNeeded available in at least one demand week (`qualifyingWeeks > 0`). Prior all-weeks gate incorrectly excluded partially-available candidates. Do not revert.
